...
namespace Substrate.Xode.RestClient
{
   ...
   public sealed class Client
   {
      ...
      public ITemplatePalletControllerClient TemplatePalletControllerClient;
      ...
      public Client(HttpClient httpClient, BaseSubscriptionClient subscriptionClient)
      {
         ...
         TemplatePalletControllerClient = new TemplatePalletControllerClient(_httpClient, _subscriptionClient);
