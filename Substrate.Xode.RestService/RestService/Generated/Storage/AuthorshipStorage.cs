...
namespace Substrate.Xode.RestService.Generated.Storage
{
    ...
    public interface IAuthorshipStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetAuthor();
    }
    ...
    public sealed class AuthorshipStorage : IAuthorshipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _authorTypedStorage;
        ...
        {
            this.AuthorTypedStorage = new TypedStorage<Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Authorship.Author", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _authorTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> AuthorTypedStorage
        {
            get
            {
        ...
        ///  Author of current block.
        /// </summary>
        public Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetAuthor()
        {
