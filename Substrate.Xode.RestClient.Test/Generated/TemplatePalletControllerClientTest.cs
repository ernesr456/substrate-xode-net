...
namespace Substrate.Xode.RestClient.Test.Generated
{
   ...
   public class TemplatePalletControllerClientTest : ClientTestBase
   {
      ...
      public async System.Threading.Tasks.Task TestSomething()
      {
         ...
         TemplatePalletControllerMockupClient mockupClient = new TemplatePalletControllerMockupClient(_httpClient);

         // Construct new subscription client to test with.
         var subscriptionClient = CreateSubscriptionClient();

         // Construct new RPC client to test with.
         TemplatePalletControllerClient rpcClient = new TemplatePalletControllerClient(_httpClient, subscriptionClient);
