...
namespace Substrate.Xode.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    /// <summary>
    /// >> 206 - Composite[cumulus_pallet_xcmp_queue.OutboundChannelDetails]
    /// </summary>
    ...
    public sealed class OutboundChannelDetails : BaseType
    {
        ...
        /// >> recipient
        /// </summary>
        public Substrate.Xode.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id Recipient { get; set; }
        /// <summary>
        /// >> state
        /// </summary>
        public Substrate.Xode.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState State { get; set; }
        /// <summary>
        /// >> signals_exist
        /// </summary>
        ...
        {
            var start = p;
            Recipient = new Substrate.Xode.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id();
            Recipient.Decode(byteArray, ref p);
            State = new Substrate.Xode.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState();
