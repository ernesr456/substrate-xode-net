...
namespace Substrate.Xode.NetApiExt.Generated.Model.pallet_collator_selection.pallet
{
    ...
    /// <summary>
    /// >> 183 - Variant[pallet_collator_selection.pallet.Call]
    /// Contains one variant per dispatchable that can be called by an extrinsic.
    /// </summary>
    public sealed class EnumCall : BaseEnumRust<Call>
    {
        ...
        public EnumCall()
        {
				AddTypeDecoder<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>(Call.set_invulnerables);
