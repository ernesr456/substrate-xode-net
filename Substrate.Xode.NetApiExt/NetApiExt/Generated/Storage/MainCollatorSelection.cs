...
namespace Substrate.Xode.NetApiExt.Generated.Storage
{
    ...
    public sealed class CollatorSelectionStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "Invulnerables"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Xode.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "Candidates"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Xode.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "LastAuthoredBlock"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        ...
        ///  The invulnerable, fixed collators.
        /// </summary>
        public async Task<Substrate.Xode.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6> Invulnerables(string blockhash, CancellationToken token)
        {
            string parameters = CollatorSelectionStorage.InvulnerablesParams();
            var result = await _client.GetStorageAsync<Substrate.Xode.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The (community, limited) collation candidates.
        /// </summary>
        public async Task<Substrate.Xode.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7> Candidates(string blockhash, CancellationToken token)
        {
            string parameters = CollatorSelectionStorage.CandidatesParams();
            var result = await _client.GetStorageAsync<Substrate.Xode.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string LastAuthoredBlockParams(Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Last block authored by collator.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> LastAuthoredBlock(Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class CollatorSelectionCalls
    {
        ...
        /// </summary>
        public static Method SetInvulnerables(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Xode.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> @new)
        {
