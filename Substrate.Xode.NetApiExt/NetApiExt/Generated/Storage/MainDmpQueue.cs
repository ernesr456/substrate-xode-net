...
namespace Substrate.Xode.NetApiExt.Generated.Storage
{
    ...
    public sealed class DmpQueueStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DmpQueue", "Configuration"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Xode.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DmpQueue", "PageIndex"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Xode.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData)));
        ...
        ///  The configuration.
        /// </summary>
        public async Task<Substrate.Xode.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData> Configuration(string blockhash, CancellationToken token)
        {
            string parameters = DmpQueueStorage.ConfigurationParams();
            var result = await _client.GetStorageAsync<Substrate.Xode.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The page index.
        /// </summary>
        public async Task<Substrate.Xode.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData> PageIndex(string blockhash, CancellationToken token)
        {
            string parameters = DmpQueueStorage.PageIndexParams();
            var result = await _client.GetStorageAsync<Substrate.Xode.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData>(parameters, blockhash, token);
            return result;
        }
