...
namespace Substrate.Xode.NetApiExt.Generated
{
    ...
    public sealed class SubstrateClientExt : Substrate.NetApi.SubstrateClient
    {
        ...
        /// <summary>
        /// TemplatePalletStorage storage calls.
        /// </summary>
        public TemplatePalletStorage TemplatePalletStorage;
                ...
                base(uri, chargeType)
        {
            ...
            this.TemplatePalletStorage = new TemplatePalletStorage(this);
        ...
        public async Task SubscribeStorageKeyAsync(Method transfer, Account account, ChargeType charge, uint lifeTime, CancellationToken none)
        {
