...
namespace Substrate.Xode.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuraExtControllerMockupClient : MockupBaseClient, IAuraExtControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "AuraExt/Authorities", value.Encode(), Substrate.Xode.NetApiExt.Generated.Storage.AuraExtStorage.AuthoritiesParams());
      }
   }
}
