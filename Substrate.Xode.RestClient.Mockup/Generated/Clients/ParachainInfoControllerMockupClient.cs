...
namespace Substrate.Xode.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ParachainInfoControllerMockupClient : MockupBaseClient, IParachainInfoControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainInfo/ParachainId", value.Encode(), Substrate.Xode.NetApiExt.Generated.Storage.ParachainInfoStorage.ParachainIdParams());
      }
   }
}
