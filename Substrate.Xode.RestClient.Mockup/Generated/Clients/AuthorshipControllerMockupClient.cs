...
namespace Substrate.Xode.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuthorshipControllerMockupClient : MockupBaseClient, IAuthorshipControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/Author", value.Encode(), Substrate.Xode.NetApiExt.Generated.Storage.AuthorshipStorage.AuthorParams());
      }
   }
}
